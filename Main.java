...
public class Main {
    public static void main(String[] args) {
        ...
        boolean tipoListaValida = true; // Variable de comprobacion para el while de mas abajo.
        ...
        boolean respuestaCorrecta = true; // Aqui cree otra variable de comprobacion para el while de toda la logica de
                                          // la lista doble
